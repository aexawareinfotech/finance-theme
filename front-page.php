...
// Get section visibility and order settings
$sections = [
    'hero' => [
        'visible' => get_theme_mod('homepage_section_hero_visible', true),
        'order' => get_theme_mod('homepage_section_hero_order', 1),
    ],
    'loans' => [
        'visible' => get_theme_mod('homepage_section_loans_visible', true),
        'order' => get_theme_mod('homepage_section_loans_order', 2),
    ],
    'process' => [
        'visible' => get_theme_mod('homepage_section_process_visible', true),
        'order' => get_theme_mod('homepage_section_process_order', 3),
    ],
    'comparison' => [
        'visible' => get_theme_mod('homepage_section_comparison_visible', true),
        'order' => get_theme_mod('homepage_section_comparison_order', 4),
    ],
    'australia' => [
        'visible' => get_theme_mod('homepage_section_australia_visible', true),
        'order' => get_theme_mod('homepage_section_australia_order', 5),
    ],
    'testimonials' => [
        'visible' => get_theme_mod('homepage_section_testimonials_visible', true),
        'order' => get_theme_mod('homepage_section_testimonials_order', 6),
    ],
    'faq' => [
        'visible' => get_theme_mod('homepage_section_faq_visible', true),
        'order' => get_theme_mod('homepage_section_faq_order', 7),
    ],
    'blog' => [
        'visible' => get_theme_mod('homepage_section_blog_visible', true),
        'order' => get_theme_mod('homepage_section_blog_order', 8),
    ],
];
...
foreach ($sections as $section_key => $section_data) {
    ...
    switch ($section_key) {
        ...
        case 'comparison':
            ...
            break;
        case 'australia':
            render_australia_section();
            break;
        case 'testimonials':
            render_testimonials_section($testimonials);
            break;
        case 'faq':
            render_faq_section($faqs);
            break;
        case 'blog':
            render_blog_section($latest_posts);
            break;
    }
}
                ...
                <div class="hero-right">
                    <div class="calculator-card">
                        ...
                        <div class="calculator-slider-wrap">
                            <input type="range" id="loan-amount-slider" class="calculator-slider" min="<?php echo esc_attr($calculator_min); ?>" max="<?php echo esc_attr($calculator_max); ?>" step="500" value="<?php echo esc_attr($calculator_min + (($calculator_max - $calculator_min) / 2)); ?>">
                            <div class="slider-labels">
                                <span>$<?php echo number_format($calculator_min); ?></span>
                                <span>$<?php echo number_format($calculator_max); ?></span>
                            </div>
                        </div>
                        <a href="<?php echo esc_url(home_url('/apply')); ?>" class="btn btn-primary btn-block"><?php echo esc_html($calculator_button); ?></a>
                    </div>
...
/**
 * Render Loan Types Section
 */
function render_loan_types_section() {
    ...
    <section class="section loan-types-section" id="loans">
        <div class="container">
            <div class="loan-types-header">
                ...
                <a href="<?php echo esc_url(home_url($loans_button_url)); ?>" class="btn btn-outline-dark"><?php echo esc_html($loans_button_text); ?></a>
            </div>
                ...
                <div class="loan-types-track" id="loan-slider-track">
                    ...
                    if (!empty($loan_posts)):
                        foreach ($loan_posts as $loan_post):
                            ...
                            ?>
                            <a href="<?php echo esc_url(get_permalink($loan_post)); ?>" class="loan-type-card">
                                <div class="loan-type-image">
                                    <img src="<?php echo esc_url($image); ?>" alt="<?php echo esc_attr(get_the_title($loan_post)); ?>" loading="lazy">
                                </div>
            ...
            <div class="slider-nav">
                <button class="slider-btn slider-btn-prev" id="slider-prev" aria-label="<?php esc_attr_e('Previous', 'finance-theme'); ?>">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 18l-6-6 6-6" /></svg>
                </button>
                <div class="slider-progress"><div class="slider-progress-bar" id="slider-progress"></div></div>
                <button class="slider-btn slider-btn-next" id="slider-next" aria-label="<?php esc_attr_e('Next', 'finance-theme'); ?>">
 ...
 */
function render_process_section() {
        ...
        <div class="container">
            <div class="process-hero-grid">
                <div class="process-image-wrapper">
                    <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/process-image.webp'); ?>" alt="<?php echo esc_attr($process_title); ?>" loading="lazy">
                </div>
                <div class="process-content">
                    ...
                    <p class="process-description"><?php echo esc_html($process_description); ?></p>
                    <div class="process-buttons">
                        <a href="#process-steps" class="btn btn-outline"><?php echo esc_html($process_btn1_text); ?></a>
                        <a href="<?php echo esc_url(home_url($process_btn2_url)); ?>" class="btn btn-outline">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="4" y="2" width="16" height="20" rx="2" /><line x1="8" y1="6" x2="16" y2="6" /><line x1="8" y1="10" x2="16" y2="10" /><line x1="8" y1="14" x2="12" y2="14" /><line x1="8" y1="18" x2="12" y2="18" /></svg>
            ...
            <div class="process-grid" id="process-steps">
                ...
                <div class="process-step">
                    <div class="process-icon process-icon-<?php echo $i; ?>"><?php echo $icons[$i]; ?></div>
 ...
 */
function render_comparison_section() {
    $comparison_title = get_theme_mod('homepage_comparison_title', 'Fair Go Loans Examples');

    // Small Loan
    $small = [
        'tier_title' => get_theme_mod('homepage_loan_small_tier_title', 'Small Loan'),
        'header' => get_theme_mod('homepage_loan_small_amount_range', 'Loan amount: $500 – $2,000') . ' | ' . get_theme_mod('homepage_loan_small_term_range', 'Loan term: 16 days – 12 months') . ' | ' . get_theme_mod('homepage_loan_small_fees', 'Fees: 20% establishment + 4% monthly (flat) | Other fees and charges may apply.'),
        'amount' => get_theme_mod('homepage_loan_small_example_amount', '$1,000'),
        'term' => get_theme_mod('homepage_loan_small_example_term', '28 weeks'),
        'fee' => get_theme_mod('homepage_loan_small_est_fee', '$200'),
        'extra_label' => __('Total monthly fee', 'finance-theme'),
        'extra_value' => get_theme_mod('homepage_loan_small_monthly_fee', '$280'),
        'total' => get_theme_mod('homepage_loan_small_total', '$1,480'),
        'weekly' => get_theme_mod('homepage_loan_small_weekly', '$70.00'),
    ];

    // Medium Loan
    $medium = [
        'tier_title' => get_theme_mod('homepage_loan_medium_tier_title', 'Medium Loan'),
        'header' => get_theme_mod('homepage_loan_medium_amount_range', 'Loan amount: $2,001 – $5,000') . ' | ' . get_theme_mod('homepage_loan_medium_term_range', 'Loan term: 9 weeks – 24 months') . ' | ' . get_theme_mod('homepage_loan_medium_fees', 'Fees: up to $400 establishment fee | Interest: up to 47.80% p.a| Other fees and charges may apply.'),
        'amount' => get_theme_mod('homepage_loan_medium_example_amount', '$2,500'),
        'term' => get_theme_mod('homepage_loan_medium_example_term', '28 Weeks'),
        'fee' => get_theme_mod('homepage_loan_medium_est_fee', '$400'),
        'extra_label' => __('Total interest', 'finance-theme'),
        'extra_value' => get_theme_mod('homepage_loan_medium_interest', '$394.74'),
        'total' => get_theme_mod('homepage_loan_medium_total', '$3,289'),
        'weekly' => get_theme_mod('homepage_loan_medium_weekly', '$117.67'),
    ];

    // Large Loan
    $large = [
        'tier_title' => get_theme_mod('homepage_loan_large_tier_title', 'Large Loan'),
        'header' => get_theme_mod('homepage_loan_large_amount_range', 'Loan amount: $5,001 – $50,000') . ' | ' . get_theme_mod('homepage_loan_large_term_range', 'Loan term: 12 weeks – 60 months') . ' | ' . get_theme_mod('homepage_loan_large_fees', 'Fees: up to $990 establishment fee | Interest: up to 47.80% p.a| Other fees and charges may apply.'),
        'amount' => get_theme_mod('homepage_loan_large_example_amount', '$10,000'),
        'term' => get_theme_mod('homepage_loan_large_example_term', '52 Weeks'),
        'fee' => get_theme_mod('homepage_loan_large_est_fee', '$990'),
        'extra_label' => __('Total interest', 'finance-theme'),
        'extra_value' => get_theme_mod('homepage_loan_large_interest', '$2,145.00'),
        'total' => get_theme_mod('homepage_loan_large_total', '$13,135'),
        'weekly' => get_theme_mod('homepage_loan_large_weekly', '$250.00'),
    ];

    $tiers = ['small' => $small, 'medium' => $medium, 'large' => $large];
    ?>
    <!-- Loan Comparison Section -->
    <section class="section comparison-section" id="loan-examples">
        <div class="container">
            <h2 class="comparison-title"><?php echo esc_html($comparison_title); ?><sup>2</sup></h2>
            <div class="comparison-grid">
                <div class="comparison-tables" style="grid-column: 1 / -1;">
                    <?php foreach ($tiers as $tier_key => $tier): ?>
                    <div class="loan-table">
                        <div class="loan-table-header loan-table-header-<?php echo $tier_key; ?>">
                            <h4><?php echo esc_html($tier['tier_title']); ?></h4>
                            <p><?php echo esc_html($tier['header']); ?></p>
                        </div>
                        <div class="loan-table-body">
                            <h5><?php esc_html_e('Example', 'finance-theme'); ?></h5>
                            <table>
                                <tr><td><?php esc_html_e('Repayments', 'finance-theme'); ?></td><td><strong><?php esc_html_e('Weekly', 'finance-theme'); ?></strong></td></tr>
                                <tr><td><?php esc_html_e('Loan Amount', 'finance-theme'); ?></td><td><strong><?php echo esc_html($tier['amount']); ?></strong></td></tr>
                                <tr><td><?php esc_html_e('Term', 'finance-theme'); ?></td><td><strong><?php echo esc_html($tier['term']); ?></strong></td></tr>
                                <tr><td><?php esc_html_e('Establishment fee', 'finance-theme'); ?></td><td><strong><?php echo esc_html($tier['fee']); ?></strong></td></tr>
                                <tr><td><?php echo esc_html($tier['extra_label']); ?></td><td><strong><?php echo esc_html($tier['extra_value']); ?></strong></td></tr>
                                <tr class="total-row"><td><?php esc_html_e('Total repayable', 'finance-theme'); ?></td><td><strong><?php echo esc_html($tier['total']); ?></strong></td></tr>
                            </table>
                            <div class="weekly-repayment weekly-repayment-<?php echo $tier_key; ?>">
                                <span><?php esc_html_e('Weekly repayment', 'finance-theme'); ?></span>
                                <strong><?php echo esc_html($tier['weekly']); ?></strong>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; ?>
...
/**
 * Render Australia Section
 */
function render_australia_section() {
    ...
    if (empty($australia_intro_template)) {
        $australia_intro = sprintf('%s holds Australian Credit Licence %s and is a member of AFCA (%s). We provide straightforward loan options that put transparency, security, and responsible lending first.', $company_name, $asic_number, $afca_number);
    } else {
        ...
        <div class="container">
            <div class="australia-grid">
                <div class="australia-content">
                    ...
                    <p class="australia-intro"><?php echo esc_html($australia_intro); ?></p>
                    <ul class="australia-features">
                        <li><svg class="check-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="20 6 9 17 4 12" /></svg><span><?php echo esc_html($australia_feature1); ?></span></li>
                        <li><svg class="check-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="20 6 9 17 4 12" /></svg><span><?php echo esc_html($australia_feature2); ?></span></li>
                        <li><svg class="check-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="20 6 9 17 4 12" /></svg><span><?php echo esc_html($australia_feature3); ?></span></li>
                    </ul>
                    <a href="<?php echo esc_url(home_url('/apply')); ?>" class="btn btn-australia">
                        <?php echo esc_html($australia_button); ?>
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14M12 5l7 7-7 7" /></svg>
                    </a>
                    <p class="australia-note"><?php echo esc_html($australia_note); ?></p>
                </div>
                <div class="australia-image">
                    <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/australia-people.png'); ?>" alt="<?php echo esc_attr($australia_title); ?>" loading="lazy">
                </div>
            </div>
        </div>
    </section>
 ...
 */
function render_testimonials_section($testimonials) {
    ...
    <section class="section testimonials-section" id="testimonials">
        <div class="container">
            ...
            <div class="testimonials-grid" id="testimonials-slider-track">
                ...
                <div class="testimonial-card">
                    ...
                    <div class="testimonial-author">
                        <div class="testimonial-avatar"><?php echo esc_html(substr($testimonial['author'], 0, 1)); ?></div>
                        <div class="testimonial-info">
                            <h4><?php echo esc_html($testimonial['author']); ?></h4>
                            <span><?php echo esc_html($testimonial['loan_type']); ?></span>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
            ...
            <div class="slider-nav">
                <button class="slider-btn slider-btn-prev" id="testimonials-prev" aria-label="<?php esc_attr_e('Previous', 'finance-theme'); ?>">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 18l-6-6 6-6" /></svg>
                </button>
                <div class="slider-progress"><div class="slider-progress-bar" id="testimonials-progress"></div></div>
                <button class="slider-btn slider-btn-next" id="testimonials-next" aria-label="<?php esc_attr_e('Next', 'finance-theme'); ?>">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18l6-6-6-6" /></svg>
                </button>
            </div>
        </div>
 ...
 * Render FAQ Section
 */
function render_faq_section($faqs) {
            ...
            <div class="faq-list">
                ...
                <div class="faq-item<?php echo $index === 0 ? ' active' : ''; ?>">
                    <button class="faq-question" aria-expanded="<?php echo $index === 0 ? 'true' : 'false'; ?>">
                        ...
                        <svg class="faq-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6" /></svg>
                    </button>
                    <div class="faq-answer"><div class="faq-answer-inner"><?php echo wp_kses_post($faq['answer']); ?></div></div>
                </div>
                <?php endforeach; ?>
            </div>
        </div>
 ...
 * Render Blog Section
 */
function render_blog_section($latest_posts) {
    ...
    <section class="section blog-section" id="blog">
        <div class="container">
                ...
                <?php if (!empty($latest_posts)): ?>
                    ...
                    <article class="blog-card">
                        <a href="<?php echo esc_url(get_permalink()); ?>" class="blog-card-image">
                            <?php if (has_post_thumbnail()): the_post_thumbnail('blog-thumbnail'); else: ?>
                            <div style="width:100%;height:100%;background:var(--gray-300);display:flex;align-items:center;justify-content:center;">
                                <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="var(--gray-400)" stroke-width="1.5"><rect x="3" y="3" width="18" height="18" rx="2" ry="2" /><circle cx="8.5" cy="8.5" r="1.5" /><polyline points="21 15 16 10 5 21" /></svg>
                            </div>
                            <?php endif; ?>
                        </a>
                        <div class="blog-card-body">
                            <div class="blog-card-meta"><time datetime="<?php echo esc_attr(get_the_date('c')); ?>"><?php echo esc_html(get_the_date()); ?></time></div>
                ...
                <?php else: ?>
                    ...
                    <article class="blog-card">
                        <div class="blog-card-image">
                            <div style="width:100%;height:100%;background:linear-gradient(135deg, var(--primary-700), var(--primary-900));display:flex;align-items:center;justify-content:center;">
                                <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="var(--white-50)" stroke-width="1.5"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z" /><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z" /></svg>
                            </div>
                        </div>
                        <div class="blog-card-body">
                            <div class="blog-card-meta"><time><?php echo esc_html($sample['date']); ?></time></div>
            ...
            <div class="text-center" style="margin-top: var(--space-10);">
                <a href="<?php echo esc_url(home_url('/blog')); ?>" class="btn btn-secondary"><?php echo esc_html($blog_button); ?></a>
            </div>
        </div>
    </section>
    <?php
